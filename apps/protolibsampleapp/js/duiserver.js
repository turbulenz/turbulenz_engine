...
$(function ()
{
    ...
    function addSliderHandler(paramstring)
    {
        ...
        htmlString += '"></div><span class="dui-control-value"></span>';
        ...
        inputElement = sliderElement.find('div').first();
        inputElement.slider(slideroptions);
        valueElement = item.element.find('.dui-control-value').first();
        inputElement.bind('slide', function (event, ui)
        {
            item.setValue(Number(ui.value));
