...
declare module TypeScript {
    ...
    class SourceMapper {
        ...
        private static _defaultDocumentMediaType;
        private jsFileName;
        ...
        private addExtensions(sourceMap);
        private addMediaTypeExtension(sourceMap);
        private setCompilerFlags(compilationSettings);
        private addCompilerFlagsExtension(sourceMap);
    }
}
declare module TypeScript {
    enum EmitContainer {
...
declare module TypeScript.Services {
    class LanguageService implements ILanguageService {
        ...
        private getTypeInfoEligiblePath(sourceUnit, position, isConstructorValidPosition);
